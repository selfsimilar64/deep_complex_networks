...
def train(d):
    ...
    if isResuming:
        ...
        if d.vis == 1:
            ...
            pngWriter.write(f, im_real_prev)
            f.close()
            f = open('im_imag_prev.png', 'w')
            pngWriter.write(f, im_imag_prev)
            f.close()
            f = open('im_mod_prev.png', 'w')
            pngWriter.write(f, im_mod_prev)
            f.close()
            f = open('im_arg_prev.png', 'w')
            pngWriter.write(f, im_arg_prev)
            f.close()
            f = open('im_real_post.png', 'w')
            pngWriter.write(f, im_real_post)
            f.close()
            f = open('im_imag_post.png', 'w')
            pngWriter.write(f, im_imag_post)
            f.close()
            f = open('im_mod_post.png', 'w')
            pngWriter.write(f, im_mod_post)
            f.close()
            f = open('im_arg_post.png', 'w')
            pngWriter.write(f, im_arg_post)
            f.close()
